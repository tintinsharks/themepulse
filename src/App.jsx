...
// ── EarningsIntel removed — functionality consolidated into EP tab ──
// Placeholder to avoid breaking anything that might reference it
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#121218", color: "#b8b8c8", fontFamily: "system-ui, -apple-system, sans-serif", display: "flex", flexDirection: "column", height: "100vh", overflow: "hidden" }}>
      ...
      <div className="tp-nav" style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 16px", borderBottom: "1px solid #222230", flexShrink: 0 }}>
        {[["terminal","Terminal"],["quad","Quadrant"],["pkn","PKN"],["scan","Scan Watch"],["ep","EP"],["ai","AI"],["exec","Execution"],["tqqq","TQQQ"]].map(([id, label]) => (
      ...
      <div ref={containerRef} className="tp-main" style={{ flex: 1, display: "flex", minHeight: 0, position: "relative" }}>
        ...
        <div className="tp-data-panel" style={{ width: chartOpen ? `${splitPct}%` : "100%", overflow: view === "scan" ? "hidden" : "auto", overflowY: view === "scan" ? "hidden" : "auto", padding: view === "scan" ? 0 : 16, transition: "none" }}>
          ...
          {view === "ai" && <ScanAnalysisView onTickerClick={openChart} activeTicker={chartTicker} stockMap={stockMap} liveThemeData={liveThemeData} />}
          </ErrorBoundary>
